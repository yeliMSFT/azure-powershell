...
FunctionsToExport = 'Get-AzMapsAccount', 'Get-AzMapsAccountKey', 'Get-AzMapsCreator', 
               'Get-AzMapsSubscriptionOperation', 'New-AzMapsAccount', 
               'New-AzMapsAccountKey', 'New-AzMapsCreator', 'Remove-AzMapsAccount', 
               'Remove-AzMapsCreator', 'Update-AzMapsAccount', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated api version to ''2021-02-01''.'
