#
# Module manifest for module 'Az.ConnectedNetwork'
#
...
FunctionsToExport = 'Get-AzConnectedNetworkDevice', 
               ...
               'New-AzConnectedNetworkDevice', 'New-AzConnectedNetworkFunction', 
